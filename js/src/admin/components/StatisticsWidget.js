...
import DashboardWidget from 'duroom/admin/components/DashboardWidget';
import SelectDropdown from 'duroom/common/components/SelectDropdown';
import Button from 'duroom/common/components/Button';
import icon from 'duroom/common/helpers/icon';
import abbreviateNumber from 'duroom/common/utils/abbreviateNumber';
    ...
    return (
      <div className="StatisticsWidget-table">
        <div className="StatisticsWidget-labels">
          <div className="StatisticsWidget-label">{app.translator.trans('duroom-statistics.admin.statistics.total_label')}</div>
          <div className="StatisticsWidget-label">
            <SelectDropdown buttonClassName="Button Button--text" caretIcon="fas fa-caret-down">
              {Object.keys(this.periods).map((period) => (
                ...
                >
                  {app.translator.trans(`duroom-statistics.admin.statistics.${period}_label`)}
                </Button>
              ))}
            </SelectDropdown>
          </div>
        ...
        {this.entities.map((entity) => {
          ...
          return (
            ...
            >
              <h3 className="StatisticsWidget-heading">{app.translator.trans('duroom-statistics.admin.statistics.' + entity + '_heading')}</h3>
